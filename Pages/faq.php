...
<?php
$questionText = "Czy koniecznie trzeba mieć receptę, żeby zamówić okulary?";
$answerText = "  Nie. 
...
<?php
$questionText = "Ile się czeka na okulary?";
$answerText = "  Czas oczekiwania zależy od rodzaju szkieł, które zostaną wybrane.
...
<?php
$questionText = "Co będzie jeżeli się nie przyzwyczaję do okularów progresywnych?";
$answerText = "  W tej sytuacji prosimy o niezwłoczny kontakt z optykiem, w którym one zostały zrobione w celu ustalenia przyczyny braku komfortu.
...
<?php
$questionText = "Czy istnieje możliwość zbadania wzroku u dzieci?";
$answerText = "  W naszych salonach niestety takiej możliwości nie ma.
...
<?php
$questionText = "Ile kosztują szkła progresywne?";
$answerText = "  Cena szkieł progresywnych jest mocno uzależniona od stopnia zaawansowania konstrukcji soczewki, niezbędnego stopnia redukcji grubości oraz innych uszlachetnień.
...
<?php
$questionText = "Czy są dostępne okulary do komputera?";
$answerText = "  Gotowych tzw “zerówek” nie mamy w ofercie.
...
<?php
$questionText = "Jakie okulary wybrać do samochodu?";
$answerText = "  Przeciwsłoneczne okulary warto wybrać z powłoką polaryzacyjną.
...
<?php
$questionText = "Jak się przygotować do badania wzroku?";
$answerText = "Wziąć poprzednie okulary i receptę
...
<?php
$questionText = "Czy można naprawić okulary?";
$answerText = "  Pewne uszkodzenia możemy naprawić. W celu ustalenia czy w danym przypadku jesteśmy w stanie pomóc prosimy o kontakt z nami: przesłanie zdjęcia uszkodzenie MMSem lub przez media społecznościowe.
...
<?php
$questionText = "Czym jest antyrefleks?";
$answerText = "  Jest to powłoka na soczewkach okularowych, która robi je bardziej przyjżyste. Każdy producvent szkieł ma w ofercie takie szkła
...
<?php
$questionText = "Czy można wymienić szkłą w swoich okularach?";
$answerText = "  Wymiana szkieł do własnej oprawy jest możliwa. Prosimy o pokazanie oprawki w celu ustalenia czy jest możliwa wymiana szkieł w danej oprawce. 
