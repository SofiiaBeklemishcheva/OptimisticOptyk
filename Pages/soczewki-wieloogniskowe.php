...
<body>
    ...
    //Opis soczewek dwuogniskowych

    <div class = "bifocal-lenses-title-container"> 
    <h2 class = "lenses-kind-title">Dwuogniskowe (bifokalne)</h2>
    <div class = "bifocal-lenses-description-container">
    <p class = "lenses-description-text" > 
...
<div class = "bifocal-lens-imagine-container">
    <img class = "bifocal-lens-image" src="ff" alt = "Schemat konstrukcji soczewek dwuogniskowych" />
    </div>

//Opis soczewek relaksacyjnych

    <div class = "relax-lenses-title-container"> 
    <h2 class = "lenses-kind-title">Relaksacyjne</h2>
    </div>
    <div class = "relax-lenses-description-container">
    <p class = "lenses-description-text" > 
...
<div class = "relax-lens-imagine-container">
    <img class = "relax-lens-image" src="ff" alt = "Schemat konstrukcji soczewek relaksacyjnych" />
    </div>


    //Opis soczewek biurowych
...
<div class = "office-lens-imagine-container">
    <img class = "office-lens-image" src="ff" alt = "Schemat do porównania konstrukcji soczewek wieloogniskowych" />
    </div>



    //Opis soczewek progresywnych 

<div class = "progressive-lenses-title-container"> 
<h2 class = "lenses-kind-title">Progresywne</h2>
</div>
<div class = "progressive-lenses-description-container">
<p class = "lenses-description-text" > 
...
<div class = "basic-progressive-lens-imagine-container">
<img class = "basic-progressive-lens-image" src="ff" alt = "Schemat konstrukcji mniej zaawansowanej soczewki progresywnej" />
</div>
<div class = "intermadiate-progressive-lens-imagine-container">
<img class = "intermadiate-progressive-lens-image" src="ff" alt = "Schemat konstrukcji bardziej zaawansowanej soczewki progresywnej" />
</div>
<div class = "advanced-progressive-lens-imagine-container">
<img class = "advanced-progressive-lens-image" src="ff" alt = "Schemat konstrukcji zaawansowanej soczewki progresywnej" />
</div>
</body>
</html>